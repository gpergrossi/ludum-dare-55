...
var scene_egg_projectile := preload("res://Scenes/Units/unit_egg_projectile.tscn") as PackedScene
var scene_tomato_plant := preload("res://Scenes/Units/unit_tomato_plant.tscn") as PackedScene
var scene_tomato_projectile := preload("res://Scenes/Units/unit_tomato_projectile.tscn") as PackedScene
var scene_pumpkin_boulder := preload("res://Scenes/Units/unit_pumpkin.tscn") as PackedScene
...
@onready var summon_default_position_left := %LeftSpawn
@onready var summon_default_position_right := %RightSpawn
...
func do_unit_hurt_opponent_caster(unit : UnitBase):
	...
	target_caster.setHealth(target_caster.health - unit.get_reach_caster_damage())
